...
- The data (downloaded from Kaggle) is compressed and can be found here: https://github.com/vuminhtue/SMU_Deep_Learning_Keras/blob/master/data/jena_climate_2009_2016.csv.gz
